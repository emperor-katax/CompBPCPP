...
#include "PathDirector_Direct.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE(FImpact_01);
...
class COMPCP_01_API UPathDirector_Direct : public UActorComponent
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UPathDirector_Direct();
